    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='Timestamp when this record was created')),
                ('modified', models.DateTimeField(auto_now=True, help_text='Timestamp when this record was last modified')),
                ('tags', models.CharField(blank=True, help_text="Comma-separated tags. Empty means 'all tags'. Example: 'budget,environment'", max_length=500)),
                ('order', models.PositiveIntegerField(default=1, help_text='Priority order for tie-breaking (lower number = higher priority)')),
            ],
            options={
