...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='followee',
            field=models.ForeignKey(help_text='The membership being followed (whose votes are inherited)', on_delete=django.db.models.deletion.CASCADE, related_name='followers', to='democracy.membership'),
        ),
        migrations.AddField(
            model_name='following',
            name='follower',
            field=models.ForeignKey(help_text='The membership who is following someone (inherits votes)', on_delete=django.db.models.deletion.CASCADE, related_name='following', to='democracy.membership'),
        ),
        migrations.AddField(
