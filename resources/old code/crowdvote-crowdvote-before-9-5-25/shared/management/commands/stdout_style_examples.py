...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(
            self.style.SQL_FIELD("sql_field - The name of a model field in SQL.")
        )
        self.stdout.write(
            self.style.SQL_COLTYPE("sql_coltype - The type of a model field in SQL.")
        )
        self.stdout.write(self.style.SQL_KEYWORD("sql_keyword - An SQL keyword."))
        self.stdout.write(
            self.style.SQL_TABLE("sql_table - The name of a model in SQL.")
        )
        self.stdout.write(
