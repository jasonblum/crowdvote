...
This module contains views for user authentication and account management,
including profile setup, username validation, and magic link authentication.
"""
...
from .forms import CaptchaProtectedMagicLinkForm
